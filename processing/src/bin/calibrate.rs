use processing::{histogram::PointHistogram, waveform_to_event, Algorithm};
...
async fn main() {
    ...
    let points = [
        ...
        (
            8.0,
            "/data/numass-server/2022_12/Electrode_4/set_1/p3(200s)(HV1=8000)",
        ),
        (
            10.0,
            "/data/numass-server/2022_12/Electrode_4/set_1/p4(200s)(HV1=10000)",
        ),
        (
            12.0,
